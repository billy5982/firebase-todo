        ...
        <Modal.Body style={{ display: 'flex', flexDirection: 'column' }}>
          <Form onSubmit={handleSubmit}>
            <Form.Group className='mb-3' controlId='formBasicEmail'>
              ...
              <Form.Control name='name' value={formValue.name} type='text' placeholder='Enter a chat todo' onChange={formChange} required />
            </Form.Group>

            <Form.Group className='mb-3' controlId='formBasicPassword'>
              <Form.Label>Todo 설명</Form.Label>
              <Form.Control name='description' value={formValue.description} type='text' placeholder='Enter a todo description' onChange={formChange} required />
            </Form.Group>

            <Form.Group className='mb-3' controlId='formBasicPassword'>
              <Form.Label>완료 일자</Form.Label>
              <Form.Control name='finDate' value={formValue.finDate} type='date' placeholder='Enter a todo description' onChange={formChange} required />
            </Form.Group>
          </Form>
        </Modal.Body>
