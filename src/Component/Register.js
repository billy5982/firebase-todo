  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className="w-[440px]  bg-[#FCF7F3] flex flex-col items-center rounded-3xl drop-shadow-xl">
        <div className="text-[24px] font-bold text-center mt-[17px] text-[#979492]">
          Register
        </div>
        <form
        ...
        >
          <div className="flex flex-col">
            <label
              htmlFor="email"
              className="text-[16px] text-[#979492] font-bold"
            >
              Email
            </label>
            <input
              type="email"
              className="w-[285px] h-[34px] border-2 border-gray-500 rounded-[5px] pl-[5px]"
              id="email"
              placeholder="Email"
          ...
          <div className="flex flex-col">
            <label
              htmlFor="password"
              className="text-[16px]  font-bold text-[#979492] text-[#979492]"
            >
              Password
            </label>
            <input
          ...
          <div className="flex flex-col">
            ...
            <input
              type="submit"
              value={"회 원 가 입"}
              className="mt-[20px] mb-4 w-[200px] h-[40px] bg-[#CFC9C3] self-center text-white font-semibold rounded-[10px] "
            />
          </div>
