  ...
  return (
    <div className="bg-white w-[240px] h-[120px] mb-3 rounded-[15px] flex flex-col p-3 drop-shadow-xl">
      <div className="flex justify-between">
        {item.timeStamp > 7 && (
          <div className="h-[7px] w-[92px] bg-green-100 p-1"></div>
        )}
        {item.timeStamp > 2 && item.timeStamp < 7 && (
          <div className="h-[7px] w-[92px] bg-yellow-100 p-1"></div>
        )}
        {item.timeStamp <= 2 && (
          <div className="h-[7px] w-[92px] bg-red-100 p-1"></div>
        )}
      </div>
